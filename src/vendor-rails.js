// ─── Vendored: @gcu/rails 0.1.0 ────────────────────────
// Upstream: auditable/ext/rails, commit d065780681bd51f52d4edc572b1b0c73d15e4559
// Re-vendored 2026-06-16 (was 5a6c7ab, 2026-06-11) for A10 4e-c — adds the
// opt-in newTabButton ([+] in each strip → `strip:newtab` event) + a
// VS-Code-style tab-insert drop-zone refinement. Re-vendor deliberately: copy
// upstream index.js, strip the trailing `export` line, keep this header.
// rails.css rides at the end of styles.css (same banner).
...
// modules into one script; createRails et al. are plain script-scope
// functions here.)
