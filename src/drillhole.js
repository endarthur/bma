...
function renderDhMapping(ds) {
  ...
  html += '<div class="dh-map-table"><div class="dh-map-title">Collar — ' + esc(D.files.collar.name) + '</div>' +
  ...
  html += '<div class="dh-map-table"><div class="dh-map-title">Survey — ' + esc(D.files.survey.name) + '</div>' +
  ...
  html += '<div class="dh-map-table"><div class="dh-map-title">Intervals — ' + esc(D.files.intervals.name) + '</div>' +
