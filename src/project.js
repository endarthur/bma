...
// (renderProjectList + #projectList removed — the pre-C14 model-less landing list
// rendered into a permanently-hidden div, fully superseded by the C14 project
// manager / renderProjects. openProjectById stays — it's the model-less reopen path.)
